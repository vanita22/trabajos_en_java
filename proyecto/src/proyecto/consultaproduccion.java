...
DefaultTableModel model = new DefaultTableModel();
    ...
    public consultaproduccion() {
        ...
        this.tablaproduccion.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        cmbproduccion = new javax.swing.JButton();
        ...
        cmbproduccion.setText("VER TABLA PRODUCCIÓN");
        cmbproduccion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbproduccionActionPerformed(evt);
            }
        });
    ...
    private void txtfiltroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfiltroKeyTyped
        ...
        trsFiltro = new TableRowSorter(tablaproduccion.getModel());
        tablaproduccion.setRowSorter(trsFiltro);
    }//GEN-LAST:event_txtfiltroKeyTyped

    private void cmbproduccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbproduccionActionPerformed
        Statement st = null;
        ...
        try {
            ...
            while(res.next()){
                ...
                try {
                    ...
                    Logger.getLogger(consultaproduccion.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    }//GEN-LAST:event_cmbproduccionActionPerformed
    ...
    private javax.swing.JButton cmbproduccion;
