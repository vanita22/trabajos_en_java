...
public class consultascontabilidad extends javax.swing.JFrame {
private TableRowSorter trsFiltro;
DefaultTableModel model = new DefaultTableModel();

    public consultascontabilidad(){
        initComponents();
        /*try{
        ...
        this.tablacontabilidad.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        cmbcontabilidad = new javax.swing.JButton();
        ...
        tablacontabilidad = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        cmbcontabilidad.setText("VER TABLA CONTABILIDAD");
        cmbcontabilidad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbcontabilidadActionPerformed(evt);
            }
        });
        ...
        tablacontabilidad.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablacontabilidad);
    ...
    private void cmbcontabilidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbcontabilidadActionPerformed
        Statement st = null;
        ...
        try {
            ...
            while(res.next()){
                ...
                try {
                    ...
                    Logger.getLogger(consultascontabilidad.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    }//GEN-LAST:event_cmbcontabilidadActionPerformed
    ...
    private void txtfiltroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfiltroKeyTyped
        ...
        trsFiltro = new TableRowSorter(tablacontabilidad.getModel());
        tablacontabilidad.setRowSorter(trsFiltro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultascontabilidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new consultascontabilidad().setVisible(true);
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> cbbfiltro;
    private javax.swing.JButton cmbcontabilidad;
    ...
    private javax.swing.JTable tablacontabilidad;
